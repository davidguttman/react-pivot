...
Download [react-pivot-standalone-1.9.1.min.js](https://raw.githubusercontent.com/davidguttman/react-pivot/master/dist/react-pivot-standalone-1.9.1.min.js)

```html
<script src='react-pivot-standalone-1.9.1.min.js'></script>
<script>
