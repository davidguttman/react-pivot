...
for (i = 0; i < nLasts; i++) lastNames.push(faker.name.lastName())
for (i = 0; i < nStates; i++) states.push(faker.address.stateAbbr())
for (i = 0; i < nCompanies; i++) companies.push(faker.company.companyName())
