...
module.exports = createReactClass({
  ...
  getColumns: function() {
    ...
    this.state.dimensions.forEach(function(title) {
      ...
      columns.push({
        ...
        className: d.className, template: d.template, onSort: d.onSort
      })
    })
    ...
    this.props.calculations.forEach(function(c) {
      ...
      columns.push({
        ...
        value: c.value, className: c.className, onSort: c.onSort
      })
    })
  ...
  updateRows: function () {
    ...
    var sortBy = sortCol.onSort || (sortCol.type === 'dimension' ? sortCol.title : sortCol.value);
