  ...
  render: function() {
    return (
      React.createElement("div", {className: "demo"}, 
        React.createElement("h1", null, "ReactPivot"), 
        ...
        React.createElement("p", null, 
          React.createElement("a", {href: "https://github.com/davidguttman/react-pivot"}, 
            "View project and docs on Github"
          )
        ), 

        React.createElement("div", {className: this.state.showInput ? 'hide' : ''}, 
          React.createElement(ReactPivot, {rows: data, 
        ...
        React.createElement("div", {className: this.state.showInput ? '' : 'hide'}, 
          React.createElement("textarea", null, JSON.stringify(data, null, 2))
        ), 

        React.createElement("p", null, 
          React.createElement("a", {className: this.state.showInput ? '' : 'strong', 
             onClick: this.toggleShow}, "Grid View"), 
          ' | ', 
          React.createElement("a", {className: this.state.showInput ? 'strong' : '', 
             onClick: this.toggleShow}, "Input Data")
        ), 
...
module.exports = React.createClass({displayName: "exports",
          ...
          React.createElement("thead", null, 
            React.createElement("tr", null, 
               columns.map(function(col) {
                return (
                  React.createElement("th", {className: (col.title === sortByTitle) ? col.className + ' ' + sortDir : col.className, 
    ...
    return (
      React.createElement("tbody", null, 
        rows.map(function(row) {
          return (
            React.createElement("tr", {key: row._key}, 
  ...
  renderCell: function(col, row) {
    ...
    return(
      React.createElement("td", {className: col.className, key: [col.title, row.key].join('\xff')}, val)
    )
  }
...
},{"./ReactCurrentOwner":47,"./ReactElement":63,"./ReactPropTypeLocations":82,"./monitorCodeUse":147,"./warning":156}],65:[function(require,module,exports){
/**
 * Copyright 2014, Facebook, Inc.
 * All rights reserved.
 *
